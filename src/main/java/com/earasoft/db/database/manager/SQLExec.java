...
public class SQLExec {
	...
	static class MySQL{
		...
		public static final String CREATE_TASK_TABLE = "CREATE TABLE IF NOT EXISTS task (taskID varchar(25), projectID varchar(25), startDate varchar(25), endDate varchar(25), totalHours INTEGER, PRIMARY KEY (taskID, projectID));";
