...
class GuiMainTimesheetController  implements ControllerI {
	private static final Logger logger = LoggerFactory.getLogger(GuiMainTimesheetController.class);

	private final ViewBind viewBind
	private final DatabaseManager databaseManager
	private final SharedController sharedController
	private final GuiMainTimesheetController self
	 ...
	 */
	public GuiMainTimesheetController(SharedController sharedController, GuiMainController guiMainController){
		this.self = this
