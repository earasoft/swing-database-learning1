...
class GuiMainResourceController  implements ControllerI {
	private static final Logger logger = LoggerFactory.getLogger(GuiMainResourceController.class);

	private final ViewBind viewBind
	private final DatabaseManager databaseManager
	private final SharedController sharedController
	private final GuiMainResourceController self
	 ...
	 */
	public GuiMainResourceController (SharedController sharedController, GuiMainController guiMainController){
		this.self = this
